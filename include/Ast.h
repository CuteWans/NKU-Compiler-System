...
public:
    enum {ADD, SUB, MUL,DIV, MOD, AND, OR, LESS, MORE, LESSE, MOREE, EQUAL, NEQUAL};
...
private:
    ...
    StmtNode *stmt2;
public:
    CFunctionDef(SymbolEntry *se, StmtNode *stmt1,StmtNode *stmt2) : se(se), stmt1(stmt1),stmt2(stmt2){};
    void output(int level);
};
